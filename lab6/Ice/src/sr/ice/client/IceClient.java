...
//			ObjectPrx base1 = communicator.stringToProxy("calc/calc22:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w³¹cza mozliwoœæ kompresji
			ObjectPrx base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w³¹cza mozliwoœæ kompresji
