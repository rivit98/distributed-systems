...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(long[] seq)
        throws NoInput
    {
        return avg(seq, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] seq, java.util.Map<String, String> context)
        throws NoInput
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] seq)
    {
        return _iceI_avgAsync(seq, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] seq, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_seq, java.util.Map<String, String> context, boolean sync)
    {
