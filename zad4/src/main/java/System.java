...
public class System extends AbstractBehavior<IMessage> {
    public System(ActorContext<IMessage> context) throws InterruptedException {
        ...
        var station1 = context.spawn(Station.create(dispatcher), "station1", props);
        var station2 = context.spawn(Station.create(dispatcher), "station2", props);
        var station3 = context.spawn(Station.create(dispatcher), "station3", props);
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        var uri = className.getResource("dispatcher.conf"); //TODO: config apply
        var configFile = new File(uri.toURI());
